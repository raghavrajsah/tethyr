...
def analyze_frame():
    ...
    try:
        ...
        response_text = get_ollama_response(prompt=prompt, image_frame=frame, system_prompt=system_prompt, model=model)

        return jsonify({"success": True, "response": response_text, "prompt": prompt})
